...
import { generateResultText } from './outpus.js';
...
describe('generateResultText()', () => {
  ...
  it('should return a string that contains the calculation result if a number provided as a result', () => {
    const result = 5;
  ...
  it('should return a string if "no-calc" is provided as a result', () => {
